import { dishClassKey, dishClassLabel, ingredientClassKey, ingredientClassLabel } from "@backend/services/catalog/catalog-classification";
import {
  type DashboardFinanceView,
  financePeriodKeys,
  isIngredientExpiring,
} from "@backend/services/dashboard/dashboard-stats";
import { startOfWeek } from "@backend/services/dashboard/menu-sales-stats";
import type { RecipeStatus } from "@backend/models/Dish";
import type { ISalesOrderItem } from "@backend/models/SalesOrder";
