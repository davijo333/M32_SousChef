...
# ## You own
#
# **Triage** — classify intent; pick a workflow from `backend/agent-service/workflows/` (see [workflows/README.md](../../workflows/README.md)). Active write flows use persisted `workflowState` (`workflowId`, `stepId`) — advance one gate per turn.
#
