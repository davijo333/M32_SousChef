...
#     if from_thread:
#         return clean_menu_dish_name(from_thread) or from_thread
#
...
#         return False
#     asks = reply_asks_kitchen_save_confirm(last_assistant)
#     if not asks:
#         return False
...
#     if wf and detect_workflow_cancel(message):
#         return _consult_route([], workflow_state=None)
#
#     if wf and (
#         detect_dish_catalog_update_message(message)
#         or detect_price_update_request(message)
#         or detect_update_ingredient_intent(message)
#         or detect_update_addon_intent(message)
#     ):
#         wf = None
#
#     if wf:
#         active_route = resolve_active_workflow(state, wf)
#         if active_route:
#             return active_route
#
#     started_route, _ = try_start_workflow(state)
#     if started_route:
...
#     if (
#         confirm
#         and (recipe_build or has_thread_recipe or awaiting_save)
...
#         has_thread_recipe or awaiting_save
...
#         return _consult_route(["inventory"], confirm_inventory=True)
#
#     # Photo/catalog-driven ingredient or add-on (workflow engine handles explicit add intents).
...
#     create_text = str(consult_results.get("create") or "")
#     from agents.head.reply_sanitizer import is_dish_brainstorm_reply, sanitize_head_reply
#
#     dish_brainstorm = "create" in consulted and is_dish_brainstorm_reply(create_text)
#     awaiting_save = (
#         thread_awaiting_kitchen_save_confirm(thread)
#         or (
#             thread_has_recipe_draft(thread)
#             and not kitchen_built_in_thread
#             and not is_dish_brainstorm_reply(create_text)
#         )
#         or (bool(recipe_build) and not kitchen_built_in_thread)
#         or dish_brainstorm
#     )
#     if awaiting_save:
#         return sanitize_head_reply(reply, state=state)
#
...
#             )
#
#     from agents.head.reply_sanitizer import sanitize_head_reply
#
#     return sanitize_head_reply(reply, state=state)
#
#
...
#     if workflow_state is not ...:
#         update["workflow_state"] = workflow_state
#     return update
