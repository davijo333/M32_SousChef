...
#
#
# def test_clean_menu_dish_name():
#     assert clean_menu_dish_name("Recipe for Avocado Spinach Toast") == "Avocado Spinach Toast"
#     assert clean_menu_dish_name("1. Avocado Spinach Toast") == "Avocado Spinach Toast"
#     assert clean_menu_dish_name("**Avocado Spinach Toast**") == "Avocado Spinach Toast"
