"""2a Recipe Researcher — propose ingredients per dish (pantry-aware when available)."""
...
def research_recipe(
    ...
    """Suggest ingredient usage for one menu item — Stage 2a."""
    if ingredients:
...
- Customizable sandwiches: base bread only.
