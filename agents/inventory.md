...
**Owns upload:** [`upload_bills`](../tools/tools/upload_bills.md) — summarize queue, classify PO vs SO routing (file parse via UI today).

## Core tools

| Tier | Tool | Built? |
|------|------|--------|
| Read | [`query_inventory`](../tools/tools/query_inventory.md) | Yes |
| Write | [`apply_inventory`](../tools/tools/apply_inventory.md) | Yes |
| Upload | [`upload_bills`](../tools/tools/upload_bills.md) | Yes |
